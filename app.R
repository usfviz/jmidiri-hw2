...
# Data
le.metadata <- read.csv("data/Metadata_Country_API_SP.DYN.LE00.IN_DS2_en_csv_v2.csv", header = TRUE, check.names = FALSE)
le.metadata <- le.metadata[, names(le.metadata) %in% c("Country Code", "Region")]

fertility <- read.csv("data/API_SP.DYN.TFRT.IN_DS2_en_csv_v2.csv", header = TRUE, check.names = FALSE, skip = 4)
...
lifeexpectancy <- read.csv("data/API_SP.DYN.LE00.IN_DS2_en_csv_v2.csv", header = TRUE, check.names = FALSE, skip = 4)
...
population <- read.csv("data/API_SP.POP.TOTL_DS2_en_csv_v2.csv", header = TRUE, check.names = FALSE)
